<section id="skills" class="skills section-bg">
    <div class="container">
      ...
      <div class="section-title">
        <h2>Skills</h2>
        <p>Mening asosiy dasturlash yonalishim bu Back-end xisoblanadi Front-end ham bilim darajaga egaman ammo ko'proq back-end dasturlash qismiga etibor beraman. Kelajak maqsadlar esa katta teamlead dasturchi bolib yetishish. </p>
      </div>
      ...
      <div class="row skills-content">
        ...
        <div class="col-lg-6" data-aos="fade-up">
          ...
          <div class="progress">
            <span class="skill">Tilda <i class="val">30%</i></span>
            <div class="progress-bar-wrap">
              <div class="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="progress">
            <span class="skill">OOP <i class="val">70%</i></span>
            <div class="progress-bar-wrap">
